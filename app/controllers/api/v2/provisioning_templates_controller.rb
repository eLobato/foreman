module Api
  module V2
    class ProvisioningTemplatesController < V2::BaseController
      ...
      def create
        @provisioning_template = ProvisioningTemplate.new(safe_params)
      ...
      def update
        process_response @provisioning_template.update_attributes(safe_params)
      end
      ...
      def clone
        ...
        @provisioning_template.name = safe_params[:name]
        process_response @provisioning_template.save
      end
      ...
      def process_operatingsystems
        return unless (template_params = safe_params) && (operatingsystems = template_params.delete(:operatingsystems))
