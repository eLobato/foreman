...
class User < ActiveRecord::Base
  ...
  attr_accessible :password, :password_confirmation, :login, :firstname, :lastname, :mail, :locale,
    :timezone, :auth_source_id, :mail_enabled,
    :default_location_id, :default_organization_id, :locations, :organizations,
    :auth_source_name, :auth_source, :role_ids, :role_names, :mail_notification_ids,
    :mail_notification_names
