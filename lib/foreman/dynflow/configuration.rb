module Foreman
  class Dynflow::Configuration
    ...
    # Loggers use the default logger for the time being

    # for logging action related info (such as exceptions raised in side
    # the actions' methods
    def action_logger
      #Foreman::Logging.logger('foreman/action')
      Rails.logger
    end
    ...
    def dynflow_logger
      Rails.logger
      #Foreman::Logging.logger('foreman/dynflow')
    end
    ...
    def world_config
      ::Dynflow::Config.new.tap do |config|
        ...
        # we can't do any operation until the Foreman.dynflow.world is set
