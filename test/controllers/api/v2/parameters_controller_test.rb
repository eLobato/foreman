...
class Api::V2::ParametersControllerTest < ActionController::TestCase
  ...
  test "should update nested host parameter" do
    ...
    assert_response :success
    assert_equal '123', Host.unscoped.find_by_name(@host.name).parameters.order("parameters.updated_at").last.value
  end
  ...
  test "should update nested domain parameter" do
    ...
    assert_response :success
    assert_equal Domain.unscoped.find_by_name("mydomain.net").parameters.order("parameters.updated_at").last.value, "123"
  end
  ...
  test "should update nested subnet parameter" do
    ...
    assert_response :success
    assert_equal Subnet.unscoped.find_by_name("five").parameters.order("parameters.updated_at").last.value, "123"
  end
  ...
  test "should update nested hostgroup parameter" do
    ...
    assert_response :success
    assert_equal Hostgroup.unscoped.find_by_name("Common").group_parameters.order("parameters.updated_at").last.value, "123"
  end
  ...
  test "should update nested os parameter" do
    ...
    assert_response :success
    assert_equal Operatingsystem.unscoped.find_by_name("Redhat").parameters.order("parameters.updated_at").last.value, "123"
  end
