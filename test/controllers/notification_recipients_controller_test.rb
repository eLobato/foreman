...
class UserNotificationsControllerTest < ActionController::TestCase
  ...
  def add_notification
    type = FactoryGirl.create(:notification_blueprint, :message => 'this test just executed successfully', :audience => 'global')
    FactoryGirl.create(:notification, :notification_blueprint => type)
  end
